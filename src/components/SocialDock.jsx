    ...
    <>
      ...
      >
        <a 
          ...
          className="text-white/60 hover:text-[#FF8EAF] transition-all duration-300 transform hover:scale-125"
          aria-label="GitHub"
        >
          <GitHubIcon />
        </a>
      ...
      >
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer" 
          className="text-white/70 hover:text-[#FF8EAF] transition-all active:scale-95 p-1"
          aria-label="GitHub"
        >
          <GitHubIcon />
        </a>
